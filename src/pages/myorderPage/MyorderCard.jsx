            ...
            <div className="max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                ...
                <img className="object-cover w-full h-48 mt-2" src={foodata.food_image} alt="nai" />
                    ...
                    <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                        ...
                        <button className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">Delete</button>
                    </div>
            </div>
        </div>
    );
