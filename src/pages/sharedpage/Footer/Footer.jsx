...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-[#191923] text-base-content rounded font-poppins">
            ...
            <aside>
                <p className="text-white">Copyright © 2024 - All right reserved by RestroBiz</p>
            </aside>
        </footer>
    );
};
